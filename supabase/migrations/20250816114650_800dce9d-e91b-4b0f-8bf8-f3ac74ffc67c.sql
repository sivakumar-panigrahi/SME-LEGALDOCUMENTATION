...
DROP POLICY IF EXISTS "Owners can create access tokens" ON public.document_access_tokens;
CREATE POLICY "Owners can create access tokens"
...
DROP POLICY IF EXISTS "Owners can view access tokens" ON public.document_access_tokens;
CREATE POLICY "Owners can view access tokens"
ON public.document_access_tokens
...
DROP POLICY IF EXISTS "Public can mark token used" ON public.document_access_tokens;
CREATE POLICY "Public can mark token used"
ON public.document_access_tokens
FOR UPDATE TO anon
USING (expires_at > now() AND used_at IS NULL)
